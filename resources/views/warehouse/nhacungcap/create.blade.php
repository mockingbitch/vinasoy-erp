...
<div class="card mb-4">
    ...
    <div class="form-group mt-4">
        ...
        <input type="text" name="tenNhaCC" class="form-control" id="inputNhaCungCap" aria-describedby="nameHelp" value="{{$data['tenNhaCC'] ?? ''}}">
    </div> 
    <div class="form-group mt-4">
        <label for="inputMaSoThue">Mã số thuế @if ($errors->has('maSoThue'))<p class="text-error">*{{$errors->first('maSoThue')}}</p>@endif</label>
        <input type="text" name="maSoThue" class="form-control" id="inputMaSoThue" aria-describedby="nameHelp" value="{{$data['maSoThue'] ?? ''}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputSDT">Số điện thoại @if ($errors->has('sdt'))<p class="text-error">*{{$errors->first('sdt')}}</p>@endif</label>
        <input type="text" name="sdt" class="form-control" id="inputSDT" aria-describedby="nameHelp" value="{{$data['sdt'] ?? ''}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputEmail">Email @if ($errors->has('email'))<p class="text-error">*{{$errors->first('email')}}</p>@endif</label>
        <input type="email" name="email" class="form-control" id="inputEmail" aria-describedby="nameHelp" value="{{$data['email'] ?? ''}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputFAX">FAX @if ($errors->has('fax'))<p class="text-error">*{{$errors->first('fax')}}</p>@endif</label>
        <input type="text" name="fax" class="form-control" id="inputFAX" aria-describedby="nameHelp" value="{{$data['fax'] ?? ''}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputWebsite">Website @if ($errors->has('website'))<p class="text-error">*{{$errors->first('website')}}</p>@endif</label>
        <input type="text" name="website" class="form-control" id="inputWebsite" aria-describedby="nameHelp" value="{{$data['website'] ?? ''}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputDiaChi">Địa chỉ @if ($errors->has('diaChi'))<p class="text-error">*{{$errors->first('diaChi')}}</p>@endif</label>
        <input type="text" name="diaChi" class="form-control" id="inputDiaChi" aria-describedby="nameHelp" value="{{$data['diaChi'] ?? ''}}">
    </div>
    <div class="form-group mt-4">
