...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == 'warehousehome' ? 'active' : ''}}" href="{{route('warehouse.home')}}">
        ...
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == 'nhacungcap' ? 'active' : ''}}" href="{{route('warehouse.nhacungcap.list')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == 'danhmuc' ? 'active' : ''}}" href="{{route('warehouse.danhmuc.list')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == 'sanpham' ? 'active' : ''}}" href="{{route('warehouse.sanpham.list')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <li class="nav-item">
          <a class="nav-link {{$breadcrumb == 'kho' ? 'active' : ''}}" href="{{route('warehouse.kho.list')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                {{-- <title>settings</title> --}}
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Warehouse</h6>
        </nav>
  ...
  <script>
    ...
    function handleSearch() {
      ...
      $.get('{{route('warehouse.search')}}', {'value': value, 'breadcrumb': breadcrumb}, function (data) {
