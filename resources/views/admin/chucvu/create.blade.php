...
<div class="card mb-4">
    ...
    <div class="form-group mt-4">
        ...
        <input type="text" name="tenChucVu" class="form-control" id="inputTenChucVu" aria-describedby="nameHelp" value="{{$data['tenChucVu'] ?? ''}}">
    </div> 
    <div class="form-group mt-4">
        <label for="inputGhiChu">Ghi chú @if ($errors->has('ghiChu'))<p class="text-error">*{{$errors->first('ghiChu')}}</p>@endif</label>
        <input type="text" name="ghiChu" class="form-control" id="inputGhiChu" aria-describedby="nameHelp" value="{{$data['ghiChu'] ?? ''}}">
    </div>
    <div class="form-group mt-4">
