...
<div class="card mb-4">
    ...
    <div class="form-group mt-4">
        ...
        <input type="text" name="loaiHDLD" class="form-control" id="inputLoaiHD" aria-describedby="nameHelp" value="{{Request::old('loaiHDLD')}}">
    </div> 
    <div class="row">
        <div class="form-group col-3 mt-4">
            ...
            <input type="date" name="ngayBatDau" class="form-control" id="inputStartDate" aria-describedby="nameHelp" value="{{Request::old('ngayBatDau')}}">
        </div>
        <div class="form-group col-3 mt-4">
            <label for="inputEndDate">Ngày kết thúc @if ($errors->has('ngayKetThuc'))<p class="text-error">*{{$errors->first('ngayKetThuc')}}</p>@endif</label>
            <input type="date" name="ngayKetThuc" class="form-control" id="inputEndDate" aria-describedby="nameHelp" value="{{Request::old('ngayKetThuc')}}">
        </div>
    </div>
    <div class="form-group mt-4">
        ...
        <input type="text" name="diaDiemLamViec" class="form-control" id="inputLocation" aria-describedby="nameHelp" value="{{Request::old('diaDiemLamViec')}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputMucLuong">Mức lương @if ($errors->has('mucLuong'))<p class="text-error">*{{$errors->first('mucLuong')}}</p>@endif</label>
        <input type="text" name="mucLuong" class="form-control" id="inputMucLuong" aria-describedby="nameHelp" value="{{Request::old('mucLuong')}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputNgachLuong">Ngạch lương @if ($errors->has('ngachLuong'))<p class="text-error">*{{$errors->first('ngachLuong')}}</p>@endif</label>
        <input type="text" name="ngachLuong" class="form-control" id="inputNgachLuong" aria-describedby="nameHelp" value="{{Request::old('ngachLuong')}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputBacLuong">Bậc lương @if ($errors->has('bacLuong'))<p class="text-error">*{{$errors->first('bacLuong')}}</p>@endif</label>
        <input type="text" name="bacLuong" class="form-control" id="inputBacLuong" aria-describedby="nameHelp" value="{{Request::old('bacLuong')}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputHeSoLuong">Hệ số lương @if ($errors->has('heSoLuong'))<p class="text-error">*{{$errors->first('heSoLuong')}}</p>@endif</label>
        <input type="text" name="heSoLuong" class="form-control" id="inputHeSoLuong" aria-describedby="nameHelp" value="{{Request::old('heSoLuong')}}">
    </div>
    <div class="form-group mt-4">
        <label for="inputPhuCap">Phụ cấp @if ($errors->has('phuCap'))<p class="text-error">*{{$errors->first('phuCap')}}</p>@endif</label>
        <input type="text" name="phuCap" class="form-control" id="inputPhuCap" aria-describedby="nameHelp" value="{{Request::old('phuCap')}}">
    </div>
    <div class="form-group mt-4">
    ...
    <div class="row">
        <div class="form-group col-3 mt-4">
            ...
            <input type="date" name="ngayKy" class="form-control" id="inputNgayKy" aria-describedby="nameHelp" value="{{Request::old('ngayKy')}}">
        </div>
    </div>
